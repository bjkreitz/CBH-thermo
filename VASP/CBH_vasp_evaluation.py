...
CBH1_matrix=pd.read_csv('VASP_CBH1_matrix', sep="\t", header=0, index_col=0)
CBH1_matrix=CBH1_matrix.fillna(0)

CBH_products=pd.read_csv('VASP_CBH1_products', sep="\t", header=0, index_col=0)
DFT_energies=pd.read_csv('VASP_CBH1_DFT_energies', sep="\t", header=0, index_col=0)
