...
nx.draw_networkx_labels(H, pos,labels, font_size=12,verticalalignment='center')
...
ax0.legend(handles=[patch_gas, patch_adsorbate], loc='lower right',bbox_to_anchor=(1,-0.075), ncol=1)
ax0.axis('off')
...
patch_gas = mpatches.Patch( facecolor='r', edgecolor='k', label='$\mathrm{gas\ thermochemistry\ (ATcT)}$')
patch_exp = mpatches.Patch(facecolor='y', edgecolor='k', label='$\mathrm{exp.\ adsorbate\ thermochemistry}$')
...
ax1.legend(handles=[patch_gas, patch_exp, patch_CBH1,patch_CBH2], loc='lower right',bbox_to_anchor=(1,-0.075), ncol=2)
