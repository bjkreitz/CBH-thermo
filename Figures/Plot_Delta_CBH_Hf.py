...
ax1.set_xticklabels((string_before + pd.Series(results_vdW.index.to_list()) + string_end).tolist(), rotation=40,va='center',  fontdict=font_label,bbox=box)    
...
ax1.plot((-1,len(binding_vdW)),(30,30),linestyle='dashed',color='k')
ax1.plot((-1,len(binding_vdW)),(-30,-30),linestyle='dashed',color='k')

for no,spcs in enumerate(binding_vdW):
    #ax1.bar(no-0.3,results_vdW.iloc[no,0] , width=0.3, color=colors[0], edgecolor='k', linewidth=3)
    ax1.bar(no,results_vdW.iloc[no,1]-results_vdW.iloc[no,0] , width=0.3, color=colors[1], edgecolor='k', linewidth=3)
    ax1.bar(no+0.3,results_vdW.iloc[no,3]-results_vdW.iloc[no,1] , width=0.3, color=colors[2], edgecolor='k', linewidth=3)
    
# #ax2.xaxis.set_label_position('top') 
# #ax2.xaxis.tick_top()
ax2.set_xticks(list(np.arange(len(bidentate))))
ax2.set_xticklabels((string_before + pd.Series(results_bidentate.index.to_list()) + string_end).tolist(), rotation=40, va='center',  fontdict=font_label,bbox=box)    
ax2.set_ylabel('$\mathrm{\Delta\Delta_fH\ (kJ\,mol^{-1})}$')
...
ax2.plot((-1,len(bidentate)),(30,30),linestyle='dashed',color='k')
ax2.plot((-1,len(bidentate)),(-30,-30),linestyle='dashed',color='k')

for no,spcs in enumerate(bidentate):
    #ax2.bar(no-0.3,results_bidentate.iloc[no,0] , width=0.3, color=colors[0], edgecolor='k', linewidth=3)
    ax2.bar(no,results_bidentate.iloc[no,1]-results_bidentate.iloc[no,0] , width=0.3, color=colors[1], edgecolor='k', linewidth=3)
    ax2.bar(no+0.3,results_bidentate.iloc[no,3]-results_bidentate.iloc[no,1] , width=0.3, color=colors[2], edgecolor='k', linewidth=3)
...
ax3.set_xticklabels((string_before + pd.Series(results_c.index.to_list()) + string_end).tolist(), rotation=40, va='center',  fontdict=font_label,bbox=box) 
ax3.set_ylabel('$\mathrm{\Delta\Delta_fH\ (kJ\,mol^{-1})}$')
...
ax3.plot((-1,len(binding_c)),(30,30),linestyle='dashed',color='k')
ax3.plot((-1,len(binding_c)),(-30,-30),linestyle='dashed',color='k')  

for no,spcs in enumerate(binding_c):
    #ax3.bar(no-0.3,results_c.iloc[no,0] , width=0.3, color=colors[0], edgecolor='k', linewidth=3)
    ax3.bar(no,results_c.iloc[no,1]-results_c.iloc[no,0] , width=0.3, color=colors[1], edgecolor='k', linewidth=3)
    ax3.bar(no+0.3,results_c.iloc[no,3]-results_c.iloc[no,1] , width=0.3, color=colors[2], edgecolor='k', linewidth=3)
...
ax4.set_xticklabels((string_before + pd.Series(results_c3.index.to_list()) + string_end).tolist(), rotation=40, va='center', fontdict=font_label,bbox=box)
ax4.set_ylabel('$\mathrm{\Delta\Delta_fH\ (kJ\,mol^{-1})}$')
ax4.set_title('$\mathbf{^*C-binding\ adsorbates\ \u2265 C_3}$', fontsize=26)
ax4.plot((-1,len(binding_c3)),(0,0),linestyle='solid',color='k')

ax4.plot((-1,len(binding_c3)),(30,30),linestyle='dashed',color='k')
ax4.plot((-1,len(binding_c3)),(-30,-30),linestyle='dashed',color='k')
...
for no,spcs in enumerate(binding_c3):
    ...
    ax4.bar(no,results_c3.iloc[no,1]-results_c3.iloc[no,0], width=0.3, color=colors[1], edgecolor='k', linewidth=3)
    #ax4.bar(no+0.3,results_c3.iloc[no,3]-results_c3.iloc[no,1], width=0.3, color=colors[2], edgecolor='k', linewidth=3)
