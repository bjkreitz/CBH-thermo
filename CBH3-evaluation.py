...
CBH_matrix=pd.read_csv('QE_CBH3_matrix', sep="\t", header=0, index_col=0)
CBH_matrix=CBH_matrix.fillna(0)

CBH_products=pd.read_csv('QE_CBH3_products', sep="\t", header=0, index_col=0)
DFT_energies=pd.read_csv('QE_CBH3_DFT_energies', sep="\t", header=0, index_col=0)

exp_hf=pd.read_csv('experiment_hf_CBH3_0K', sep="\t", header=0, index_col=0)
