...
class Molecule:
        ...
        def __init__(self):
                ...
                self.Eref={'CH4':-315.5925486,'H2O':-600.1601233,'H2':-31.57369813,'NH3':-442.6510481} #DFT energies of the reference species (ZPE corrected) in eV
                self.Eslab=-367730.0349 #DFT energy of the slab in eV
