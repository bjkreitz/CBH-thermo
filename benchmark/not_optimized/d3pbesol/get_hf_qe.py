...
class Molecule:
        ...
        def __init__(self):
                ...
                self.Eref={'CH4':-314.4762858,'H2O':-598.5715484,'H2':-31.46517069,'NH3':-442.6510481} #DFT energies of the reference species (ZPE corrected) in eV
                self.Eslab=-366018.3926 #DFT energy of the slab in eV
