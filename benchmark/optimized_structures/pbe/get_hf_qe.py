...
class Molecule:
        ...
        def __init__(self):
                ...
                self.Eref={'CH4':-314.4793234,'H2O':-598.5741635,'H2':-31.46903444,'NH3':-442.6510481} #DFT energies of the reference species (ZPE corrected) in eV
                self.Eslab=-366018.8821 #DFT energy of the slab in eV
...
test = Molecule()
#parse_input_file('energies/CCO.dat',test)
#compute_thermo(test)
...
old_deltaHf_sorted=deltaHf.sort_values('species')
