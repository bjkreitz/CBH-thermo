...
class Molecule:
        ...
        def __init__(self):
                ...
                self.Eref={'CH4':-316.4157664,'H2O':-600.7419352,'H2':-31.79667977,'NH3':-442.6510481} #DFT energies of the reference species (ZPE corrected) in eV
                self.Eslab=-366518.203 #DFT energy of the slab in eV
...
test = Molecule()
parse_input_file('energies/CCH3.dat',test)
compute_thermo(test)
